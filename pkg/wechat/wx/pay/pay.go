...
import (
	...
	"github.com/zhanghup/go-framework/pkg/wechat/wx/util"
	"sort"
	"strconv"
)
...
// PrePayOrder return data for invoke wx payment
...
// PrePayID will request wx merchant api and request for a pre payment order id
